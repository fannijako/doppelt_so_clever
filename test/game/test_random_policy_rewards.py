...
from model.rl_utils import run_episode
...
class TestRandomPolicyShapedRewards:
    def test_non_zero_step_rewards_before_terminal(self):
        random.seed(0)
        trajectory, _score = run_episode(
            _random_policy, augmented=False, max_rounds=2, training=True,
        )
